...
import { PROFILE_CONNECT_UPDATE } from '../profile/actionTypes';
/*
	Actions for calling APIs for Follow button functionality
*/

export function connectAction(actionData) {
  return {
    type: PROFILE_CONNECT_UPDATE,
    subType: actionData.subType,
    relationId: actionData.relationId,
