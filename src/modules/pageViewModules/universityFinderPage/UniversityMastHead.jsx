...
import { UniversitySearchForm, actions as searchFormActions } from '../../universitySearch';
...
*/
class UniversityMastHead extends React.Component {
...
<UniversitySearchForm {...this.props} />
</div>
</div>
</EasyTransition>
</div>
...
<h1 className="ui inverted huge header center aligned">Find The Right College For You
</h1>
<UniversitySearchForm {...this.props} />
</div>
</div>
...
export default connect(null, mapDispatchToProps)(UniversityMastHead);
